...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($name==""): ?>
        <?php echo $__env->make('components.name', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>   
    <?php else: ?>
        <div class="main__content__chat-sender">
            <p class="main__content__chat-sender__user">Guest</p>
            <p class="main__content__chat-sender__message"><?php echo e($name); ?></p>
        </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/first-level/singin.blade.php ENDPATH**/ ?>