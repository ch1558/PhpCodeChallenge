...
@section('content')
    ...
    @else
        ...
        <div class="main__content__chat">
            <p class="main__content__chat__user">Currency bot</p>
            <p class="main__content__chat__message">Please give me the amount of money you want to withdraw, <strong>{{ $limit }}</strong></p>
        </div>
        ...
        @else
            ...
            <div class="main__content__response">
                ...
                <div class="main__content__response__container">
                    <form class="main__content__response__container--form" method="get" action="{{ route('redirectWithdraw') }}">
